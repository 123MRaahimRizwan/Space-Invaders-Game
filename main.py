...
# Ship class for our player


class Ship:
    COOLDOWN = 30
    # Defining our methods for the ship class
...
# Creating our player class which is inherited from the Ship class


class Player(Ship):
    # Defining our methods for the player class
    def __init__(self, x, y, health=100):
...
class Enemy(Ship):
    # Dictionary for colors of our lasers
    COLOR_MAP = {
